...
class BonCommande extends CI_Model {
	...
	public function getlistBC($where = array('bc.status' => 'L')) {

		

		$this->db->select('bc.id AS idBC, bc.numero, bc.date, bc.tva, bc.ctrl_remarque, f.raison_social as fournisseurs_raison_social');
