...
class Depenses extends MY_Controller {
	...
	public function index()	{
		...
		$data['interesses'] = $this->Interesse->getAll();
	...
	public function add()
	{
		...
		if($data_['id_depense_categorie']==1){
			...
			$dataDep = array('reference' =>$data_['reference_fac'], 'object' => $data_['object_fac'],'date' => $data_['date_fac'], 'id_fournisseur' => $data_['id_fournisseur_fac'], 'mht' => $data_['mht_fac'], 'mttc' => $data_['mttc_fac'], 'tva' => $data_['tva_fac'], 'id_depense_categorie' => $data_['id_depense_categorie'], 'id_budget_etab' => $budget_etablissements_id, 'id_projet' => $data_['id_projet'], 'id_sousprojet' => $data_['id_sousprojet']);
		}
		...
		elseif($data_['id_depense_categorie']==3){
			...
			$dataDep =array('reference' =>$data_['reference_dv'], 'object' => $data_['object_dv'],'date' => $data_['date_dv'], 'interesse' => $data_['interesse_dv'],'mttc' => $data_['mttc_dv'],'id_depense_categorie' => $data_['id_depense_categorie'], 'id_budget_etab' => $budget_etablissements_id, 'id_projet' => $data_['id_projet'], 'id_sousprojet' => $data_['id_sousprojet']);
		}
		else{
