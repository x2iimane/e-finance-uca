...
class BC extends MY_Controller {
	...
	public function add($bc = true)
	{
		...
		/* Adding New BC */
		$dataBC = array('numero' =>$data_['numero'], 'date' => $data_['date'], 'fournisseurs_id' => $data_['fournisseurs_id'], 'tva' => $data_['tva'], 'nature_prestation' => $data_['nature_prestation'], 'project_id' =>$data_['project_id'], 'sub_project_id' =>$data_['sub_project_id']);
