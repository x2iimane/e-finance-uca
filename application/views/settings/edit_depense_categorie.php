...
<div class="breadcrumb-wrapper">
	<h4 class="mainTitle no-margin">Gestion des Dépenses Catégorie</h4>
	<ul class="pull-right breadcrumb">
		<li><a href="<?=base_url()?>dashboard"><i class="fa fa-dashboard margin-right-5 text-large text-dark"></i>Dashboard</a></li>
		<li><a href="<?=base_url()?>settings/editDepenseCategorie"><i class="fa fa-edit margin-right-5 text-large text-dark"></i>Nouveau</a></li>
		<li><a href="<?=base_url()?>settings/listDepenseCategorie"><i class="fa fa-list margin-right-5 text-large text-dark"></i>liste</a></li>
	</ul>
</div>
			...
			<div class="col-md-12">
				<div class="panel panel-white">
					<div class="panel-body">
							<form action="<?=base_url()?>settings/saveDepenseCategorie" method="POST">
								<input type="hidden" name="id" value="<?=(isset($data->id))?$data->id:''?>">
							<fieldset>
								<legend>
									Ajouter / Modifier une Dépense Catégorie
								</legend>
