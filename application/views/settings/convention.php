		...
		<div class="col-md-12">
			<div class="panel panel-white">
				<div class="panel-body">
					<p>
						<button type="button" class="btn btn-default" onclick="window.location.assign('<?=base_url()?>settings/editConvention/')">
							Nouvelle Convention 
						</button>
					</p>
					<table class="table table-hover" id="sample-table-1">
						...
						<tbody>
							...
							<tr>
								...
								<td class="hidden-xs"><?=$row->numero?></td>
								<td><?=$row->objet?></td>
								<!--<td><?=$row->etablissements_id?></td>-->
								<td class="center">
								<div class="visible-md visible-lg hidden-sm hidden-xs">
									<a href="<?=base_url()?>settings/editConvention/<?=$row->id?>" class="btn btn-transparent btn-xs"  data-toggle="tooltip" data-placement="top" title="Modifier"><i class="fa fa-pencil"></i></a>
